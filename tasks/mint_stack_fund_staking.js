...
task('mint-stack')
  .setAction(async function () {
    ...
    const tx = await instance
      .connect(sender)
      .mint(deployments.unstackFixedMain, ethers.utils.parseUnits("105210", 18));
    await tx.wait();

    const tx2 = await instance
      .connect(sender)
      .mint(deployments.stackFixedMain, ethers.utils.parseUnits("3148950", 18));
    await tx2.wait();
