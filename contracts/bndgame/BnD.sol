...
contract BnD is IBnD, ERC721Enumerable, Ownable, Pausable {
    ...
    constructor(uint256 _maxTokens) ERC721("Wizards & Dragons Game", "BnD") {
    ...
    */
    function isWizard(uint256 tokenId) external view override blockIfChangingToken(tokenId) returns (bool) {
        ...
        IBnD.WizardDragon memory s = tokenTraits[tokenId];
        return s.isWizard;
    }
