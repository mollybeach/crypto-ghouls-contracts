...
contract BabyDolls is ERC721Enumerable, Ownable {
    ...
    function setContracts(address _dollAddress) public onlyOwner {
    ...
    function dollClaim(uint256 tokenId) public {
        ...
        require(dollAddress.ownerOf(tokenId) == msg.sender, "Not the owner of this pudgy");
        require(DOLL_CLAIMS + 1 <= MAX_DOLL_CLAIM, "All pudgy reservations claimed");
